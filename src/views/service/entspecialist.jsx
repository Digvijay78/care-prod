...
// Images
import entSpecialist from '/assets/images/service/ent-specialist.webp'
...
export default function EntSpecialist() {
  return (
    <Fragment>
    <BreadCrumb title="ENT Specialist" />
            ...
            <div className="bg-primary-subtle p-3 p-md-4">
              <div className="service-menu">
                <ul className="list-inline m-0">
                  ...
                  <li className="mb-3">
                    <ServiceMenu isActive={true} serviceUrl="/service/entspecialist" serviceTitle="ENT Specialist" />
                  </li>
                  <li className="mb-3">
                    <ServiceMenu serviceUrl="/service/cardiologist" serviceTitle="Cardiologist" />
                  </li>
                  <li className="mb-3">
                    <ServiceMenu serviceUrl="/service/audiologist" serviceTitle="Audiologist" />
                  </li>
                  <li className="mb-3">
          ...
          <Col lg="8" className="mt-lg-0 mt-5">
            <div className="about-service">
              <div className="position-relative">
                <Image src={entSpecialist} className="img-fluid" alt="image" />
              ...
              <div className="iq-title-box mt-5 mb-0">
                ...
                <h3 className="iq-title iq-heading-title mb-2">
                   <span className="right-text text-capitalize fw-500">ENT Specialist </span>
