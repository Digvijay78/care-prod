...
import TeamStandard from '../../widgets/TeamStandard';
...
export default function GlobalTeamStandard() {
              ...
              >
                  {teamData.map((item, index) => (
                      <SwiperSlide key={index}>
                          <TeamStandard teamImage={item.teamImage} teamMemberName={item.teamMemberName} teamSpecialized={item.teamSpecialized} />
                      </SwiperSlide>
                  ))}                        
              </Swiper>
          </Container>
