...
export default function BlogStandard({isDesc, isTag, ...props}) {
  return (
    <div className="iq-blog blog-standard position-relative">
      ...
      <div className="iq-post-details bg-white p-4">
          ...
          {isDesc === true && (
            <p className="overflow-hidden m-0">{props.blogDescription}</p>
          )}
