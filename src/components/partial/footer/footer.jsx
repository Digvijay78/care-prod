...
const Footer = memo((props) => {
    ...
    return(
        <footer>
                    ...
                    <Row>
                        <Col lg="4" md="6" className="mb-5 mb-lg-0">
                            <div className="pe-lg-5">
                                    {/* logo */}
                                <Logo />
                                <h5 className="iq-heading-title mt-5">Newsletter</h5>
                                <p className=" mt-2 mb-4">It is a long established fact that a reader will be distracted by the
                                    readable content of a page when
                                    looking at its layout. </p>
                                    <div className="custom-form-field pe-sm-5 me-sm-5">
                        ...
                        <Col lg="3" md="6" className="mt-md-0 mt-5">
                            ...
                            <ul className="p-0 m-0 list-unstyled">
                                <li className="mb-3">
                                    <a className="d-flex gap-3" href="tel:+0123456789">
                                        <span className="text-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon-20" viewBox="0 0 27 27"
                                                fill="none">
                                                <mask maskUnits="userSpaceOnUse" x="0" y="0" width="27"
                                                    height="27">
                                        ...
                                        <span className="text-body">+0123456789</span>
                                    </a>
                                </li>
                                <li className="mb-3">
                                    <a className="d-flex gap-3" href="mailto:support@example.com">
                                        <span className="text-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon-20" viewBox="0 0 28 25"
                                                fill="none">
                                                <path fillRule="evenodd" clipRule="evenodd"
                                                    ...
                                                    fill="currentColor"></path>
                                                <mask maskUnits="userSpaceOnUse" x="0" y="0" width="28"
                                                    height="25">
                                                    <path fillRule="evenodd" clipRule="evenodd"
                                        ...
                                        <span className="text-body">support@example.com</span>
                                    </a>
                                </li>
                                <li className="d-flex gap-3">

                                    <span className="text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon-20" viewBox="0 0 21 25" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd"
                                                ...
                                                fill="currentColor"></path>
                                            <mask maskUnits="userSpaceOnUse" x="0" y="0" width="21"
                                                height="25">
            ...
            <div className="footer-bottom bg-primary-subtle border-top text-body">
